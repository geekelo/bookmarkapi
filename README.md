...
# 📖 Bookmark API <a name="about-project"></a>


**Bookmark API** A Rails app with API mode (no UI) and specs to test the API endpoints. It handles and tests creation of bookmarks, updating of bookmarks, params validation, users authentication.
This project was inspired and guided by this [resource](https://rubyyagi.com/rspec-request-spec/) by Ruby Yag: 
...
```sh
   git clone https://github.com/geekelo/bookmarkapi.git
   cd rails-blog-app
```
...
I would like to acknowledge Ruby Yag for the insightful and helpful [resource](https://rubyyagi.com/rspec-request-spec/)
